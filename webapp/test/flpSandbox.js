		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lista",
									"targetURL": "#MauAppmauapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MauAppmauapp-display": {
								"semanticObject": "MauAppmauapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MauApp.mauapp",
									"url": sap.ui.require.toUrl("MauApp/mauapp")
								}
							}
						}
					}
